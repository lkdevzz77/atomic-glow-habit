-- Otimizar função get_habit_completion_xp com tratamento de erro
...
BEGIN
  ...
  IF v_total_xp IS NULL OR v_total_xp < base_xp THEN
    v_total_xp := base_xp;
...
EXCEPTION WHEN OTHERS THEN
  ...
  RETURN QUERY SELECT base_xp, ARRAY['Hábito completado (erro)']::text[];
END;
$function$;